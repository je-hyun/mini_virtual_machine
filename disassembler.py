'''
This is a dissasembler for LC-3 assembler code.

This code is completely from:
https://github.com/ianklatzco/lc3/blob/master/lc3disas.py
I do not claim ownership of this disassembler code in any way.
'''
